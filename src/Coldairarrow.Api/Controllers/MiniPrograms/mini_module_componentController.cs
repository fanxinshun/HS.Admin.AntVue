...
namespace Coldairarrow.Api.Controllers.MiniPrograms
{
    ...
    public class mini_module_componentController : BaseApiController
    {
        #region DI

        public mini_module_componentController(Imini_module_componentBusiness mini_module_componentBus)
        {
            _mini_module_componentBus = mini_module_componentBus;
        }

        Imini_module_componentBusiness _mini_module_componentBus { get; }
        ...
        /// <returns></returns>
        [HttpPost]
        public async Task<PageResult<ModuleComponentDTO>> GetModuleComponentList(PageInput<ConditionDTO> input)
        {
        ...
        {
            return await _mini_module_componentBus.GetModuleComponent(input);
        }
