          ...
          <a-col :md="4" :sm="24">
            <a-form-item label="查询类别">
              <a-select allowClear v-model="queryParam.condition">
                <a-select-option key="Module_Code">页面编码</a-select-option>
  ...
  export default {
    ...
    methods: {
      ...
      getDataList() {
        ...
        this.loading = true
        this.$http
          .post('/MiniPrograms/mini_module/GetDataList', {
      ...
      handleEditTo(id) {
        this.$router.push({
          path: '/MiniPrograms/mini_module_component/List',
          query: {
            Module_Id: id
          }
        })
        ...
        this.$confirm({
          ...
          onOk() {
            return new Promise((resolve, reject) => {
              thisObj.$http.post('/MiniPrograms/mini_module/DeleteData', ids).then(resJson => {
                resolve()
