  ...
  export default {
    ...
    methods: {
      ...
      getDataList() {
        ...
        this.loading = true
        this.$http
          .post('/MiniPrograms/mini_component_item/GetMiniComponentProductList', {
      ...
      hanldleAdd() {
        ...
        if (!componentId) {
          this.$message.error('请先到页面组件页面重新点击要编辑的数据，然后在新建')
          return
        }
        ...
        this.$confirm({
          ...
          onOk() {
            return new Promise((resolve, reject) => {
              thisObj.$http.post('/MiniPrograms/mini_component_item/DeleteData', ids).then(resJson => {
                resolve()
