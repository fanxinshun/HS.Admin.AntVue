          ...
          <a-col :md="4" :sm="24">
            <a-form-item label="查询类别">
              <a-select allowClear v-model="queryParam.condition">
                <a-select-option key="PageTypeName">类型</a-select-option>
                <a-select-option key="Name">页面名称</a-select-option>
              </a-select>
            </a-form-item>
          </a-col>
          <a-col :md="4" :sm="24">
  ...
  export default {
    ...
    methods: {
      ...
      getDataList() {
        ...
        this.loading = true
        this.$http
          .post('/MiniPrograms/mini_page/GetDataList', {
      ...
      handleEditTo(pageId) {
        this.$router.push({
          name: '/MiniPrograms/mini_page_component/List',
          params: {
            pageId: pageId
          }
        })
        // this.$router.push({
        //   path: '/MiniPrograms/mini_page_component/List',
        //   query: {
        //     Page_Id: id
        //   }
        // })
        ...
        this.$confirm({
          ...
          onOk() {
            return new Promise((resolve, reject) => {
              thisObj.$http.post('/MiniPrograms/mini_page/DeleteData', ids).then(resJson => {
                resolve()
